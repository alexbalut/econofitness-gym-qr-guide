...
Credentials: `admin@econofitness.demo` / `demo1234`
...
Seed **wipes** gyms, users, machines, and issues, then recreates Éconofitness Montréal — Salaberry with 10 machines and sample issues/views.
