...
async function main() {
  console.log("Seeding Éconofitness Montréal — Salaberry...");
  ...
  const gym = await prisma.gym.create({
    data: {
      name: "Éconofitness Montréal — Salaberry",
      slug: "econofitness-montreal",
      tagline: "Super beaux gyms, très bas prix",
      primaryColor: "#EEAF00",
  ...
  console.log("   Gym: Éconofitness Montréal — Salaberry");
  console.log("   Login: admin@econofitness.demo / demo1234");
