    ...
    return (
      <main className="mx-auto max-w-xl px-4 py-16 text-center">
        ...
        <p className="text-slate-400 mb-6">
          Run <code className="text-yellow-300">npm run seed</code> to load Éconofitness Montréal.
        </p>
