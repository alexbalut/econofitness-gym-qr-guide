        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex rounded-xl border border-border overflow-hidden text-sm font-semibold shrink-0">
            <button
              type="button"
              onClick={() => setLang("en")}
              className={`px-2.5 py-1.5 ${lang === "en" ? "bg-[#EEAF00] text-black" : "bg-[#353535] text-neutral-300"}`}
            >
              EN
            </button>
            <button
              type="button"
              onClick={() => setLang("fr")}
              className={`px-2.5 py-1.5 ${lang === "fr" ? "bg-[#EEAF00] text-black" : "bg-[#353535] text-neutral-300"}`}
            >
              FR
            </button>
          </div>
